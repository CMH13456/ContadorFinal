...
public class EmbeMejoras extends RecyclerView.ItemDecoration {
    ...
    public EmbeMejoras(int topSpaceHeight, int bottomSpaceHeight, int leftSpaceHeight, int rightSpaceHeight) {
